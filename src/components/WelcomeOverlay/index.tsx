    ...
    >
      ...
      <div className='mx-auto max-w-2xl px-8 text-center'>
        ...
        <div className='mb-12 space-y-6'>
          <div className='group flex items-center justify-center space-x-4 text-slate-600 dark:text-slate-300'>
            <div className='flex size-8 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 text-sm font-bold text-white shadow-lg'>
              1
            </div>
          ...
          <div className='group flex items-center justify-center space-x-4 text-slate-600 dark:text-slate-300'>
            <div className='flex size-8 items-center justify-center rounded-full bg-gradient-to-r from-green-500 to-emerald-500 text-sm font-bold text-white shadow-lg'>
              2
            </div>
          ...
          <div className='group flex items-center justify-center space-x-4 text-slate-600 dark:text-slate-300'>
            <div className='flex size-8 items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-sm font-bold text-white shadow-lg'>
              3
            </div>
      ...
      <div className='absolute left-1/4 top-1/4 size-32 rounded-full bg-gradient-to-r from-pink-300/40 to-purple-300/40 opacity-60 blur-2xl delay-700' />
      <div className='absolute bottom-1/4 right-1/4 size-40 rounded-full bg-gradient-to-r from-blue-300/40 to-cyan-300/40 opacity-60 blur-2xl delay-1000' />
      <div className='absolute top-1/2 left-1/8 size-16 rounded-full bg-gradient-to-r from-emerald-300/30 to-teal-300/30 opacity-50 blur-xl delay-500' />
      <div className='absolute bottom-1/3 left-3/4 size-20 rounded-full bg-gradient-to-r from-orange-300/30 to-yellow-300/30 opacity-50 blur-xl delay-1500' />
    </div>
  );
};
